@include('unlogged.layout.header')
...
<div class="section section-our-team-freebie">
    <div class="parallax filter filter-color-black">
        <div class="image" style="background-image:url('{{ asset('assetsunlogged/img/header-2.jpeg') }}')">
        </div>
        <div class="container">
            <div class="content">
                <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card card-member">
                                        <div class="content">
                                            <div class="avatar avatar-danger">
                                                <img alt="..." class="img-circle" src="{{ asset('assetsunlogged/img/faces/face_1.jpg') }}"/>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-member">
                                        <div class="content">
                                            <div class="avatar avatar-danger">
                                                <img alt="..." class="img-circle" src="{{ asset('assetsunlogged/img/faces/face_4.jpg') }}"/>
                                            </div>
                                            <div class="description">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-member">
                                        <div class="content">
                                            <div class="avatar avatar-danger">
                                                <img alt="..." class="img-circle" src="{{ asset('assetsunlogged/img/faces/face_3.jpg') }}"/>
                                            </div>
                                            <div class="description">
            ...
            <li class="active">
                <a href="#testimonial1" role="tab" data-toggle="tab">
                    <div class="image-clients">
                        <img alt="..." class="img-circle" src="{{ asset('assetsunlogged/img/faces/face_5.jpg') }}"/>
                    </div>
                </a>
            </li>
            <li>
                <a href="#testimonial2" role="tab" data-toggle="tab">
                    <div class="image-clients">
                        <img alt="..." class="img-circle" src="{{ asset('assetsunlogged/img/faces/face_6.jpg') }}"/>
                    </div>
                </a>
            </li>
            <li>
...
<div class="section section-small section-get-started">
    <div class="parallax filter">
        <div class="image"
            style="background-image: url('{{ asset('assetsunlogged/img/office-1.jpeg') }}')">
        </div>
        <div class="container">
            <div class="title-area">
...
@include('unlogged.layout.footer')
